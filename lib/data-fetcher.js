...
export async function fetchHomeData() {
  return fetchDocCached("websites/humanbiomedicalsorg/pages/home");
}

export async function fetchContactData() {
  return fetchDocCached("websites/humanbiomedicalsorg/pages/contact");
}

export async function fetchServicesData() {
  return fetchDocCached("websites/humanbiomedicalsorg/pages/services");
}

export async function fetchDistrictData(district) {
  if (!district) return null;
  return fetchDocCached(`websites/humanbiomedicalsorg/districts/${district}`);
}
