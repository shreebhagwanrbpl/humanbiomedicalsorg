        ...
        <div className="max-w-7xl mx-auto px-5 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="text-center max-w-4xl mx-auto">
            ...
            <p className="mt-8 text-lg sm:text-xl text-slate-600 leading-9">
              Human Biomedicals LLP is a trusted healthcare equipment company
          ...
          <div className="grid lg:grid-cols-2 gap-10">
            ...
            <div className="glass rounded-[32px] p-10 shadow-xl">
              ...
              <p className="mt-6 text-slate-600 leading-9 text-lg">
                Human Biomedicals LLP focuses on delivering premium laboratory
            ...
            <div className="glass rounded-[32px] p-10 shadow-xl">
              ...
              <p className="mt-6 text-slate-600 leading-9 text-lg">
                Human Biomedicals LLP continuously works towards innovation,
      ...
      <section className="pb-28 relative z-10">
        ...
        <div className="max-w-7xl mx-auto px-5 sm:px-6 lg:px-8">
          ...
          <div className="text-center max-w-4xl mx-auto">
            ...
            <p className="mt-8 text-lg sm:text-xl text-slate-600 leading-9">
              Human Biomedicals LLP delivers reliable healthcare equipment
