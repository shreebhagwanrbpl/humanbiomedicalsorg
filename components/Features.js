...
const data = [
  {
    ...
    desc: "Advanced laboratory instruments and diagnostic systems for modern healthcare laboratories.",
  },
  {
    icon: <Hospital size={38} />,
    title: "Hospital Solutions",
    desc: "Premium hospital machines and healthcare devices for medical institutions and clinics.",
  },
  {
    icon: <ShieldCheck size={38} />,
    title: "Trusted Support",
    desc: "Reliable product quality, fast delivery, and professional technical support services.",
  },
];
